...
function handleLandingPlanSubscription(orgID, apiID, apiReferenceID, policyID, policyName, buttonElement) {
  console.log('🟢 handleLandingPlanSubscription called', { orgID, apiID, apiReferenceID, policyID, policyName });
  ...
  if (isPaid) {
    console.log('💳 Paid plan - calling landingSubscribeAndCheckout');
...
async function landingSubscribeAndCheckout(orgID, apiID, apiReferenceID, policyID, policyName) {
  console.log("💰 landingSubscribeAndCheckout called", { orgID, apiID, apiReferenceID, policyID, policyName });
  ...
  try {
    ...
    console.log("💰 Landing page applicationID:", applicationID);
    ...
    console.log("💰 Policy Name:", policyNameAttr);
